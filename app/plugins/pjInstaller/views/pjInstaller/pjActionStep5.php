...
<div class="i-wrap">
	...
	<div class="t20">
		...
		<form action="index.php?controller=pjInstaller&amp;action=pjActionStep6&amp;install=1" method="post" id="frmStep5" class="i-form float_right">
			<input type="hidden" name="step5" value="1" />
			<input type="button" tabindex="2" value="&laquo; Back" class="pj-button" onclick="window.location='index.php?controller=pjInstaller&amp;action=pjActionStep4'" />
