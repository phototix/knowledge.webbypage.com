...
(function ($, undefined) {
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var optColumns = [
								{text: myLabel.name, type: "text", sortable: false, editable: false, renderer: formatName, width: 460},
								{text: myLabel.questions, type: "text", sortable: false, editable: false, align: "center"},
			...
			var optFields =  ['data', 'questions', 'data', 'data'];
			if(pjGrid.up_down == false)
			{
				optColumns = [
								{text: myLabel.name, type: "text", sortable: false, editable: false, renderer: formatName, width: 500},
								{text: myLabel.questions, type: "text", sortable: false, editable: false, align: "center"},
			                  ];
				optFields =  ['data', 'questions'];
			}
